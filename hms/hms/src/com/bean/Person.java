...
public class Person {
	...
	public Choose1 getChoose1() {
		return choose1;
	}
	public void setChoose1(Choose1 choose1) {
	...
	public String toString() {
		return "Person [id=" + id + ", p0_name=" + p0_name + ", p0_uid="
				...
				+ oh_id + ", sign_state=" + sign_state + ", move_state="
				...
				+ ", remark=" + remark + ", choose1=" + choose1 + ", newHouse="
				+ newHouse + "]";
	}
